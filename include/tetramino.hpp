...
namespace Tetris
{
    ...
    protected:
        ...
        static Tetramino* next_tetramino;
        ...
        void set_correct_pos_next();
        void render_next_tetramino(sf::RenderWindow& window);
    ...
    public:
        ...
        bool is_next_tetramino() const override;
        ...
        static void init_next_tetramino();
