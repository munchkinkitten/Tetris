#include <J_tetramino.hpp>
#include <iostream>

JTetramino::JTetramino()
{
    start_position = {640 / 2, 20};
    for (int i = 0; i < 4; i++)
    {
        sf::Sprite* square = new sf::Sprite();
        square->setTexture(*different_squares[2]);
...
void JTetramino::set_start_pos(sf::Vector2u position)
{
    for (int i = 0; i < 3; i++)
    {
